...
public class TestUtils {
	...
	/**
	 * Returns the environment that can be used to configure tests. This loads all
	 * environment variables and variables stored in the working directories
	 * ".test.env" file. The latter take precedence.
	 */
	...
	/**
	 * Returns the version of 1password CLI that is stored in the "op.version" test
	 * resource and downloaded by Gradle during bootstrapping
	 */
